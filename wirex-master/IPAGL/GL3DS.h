...
struct t3DObject 
{
	...
	CVector3f  *pVerts;			//!< The object's vertices
	CVector3f  *pNormals;		//!< The object's normals
	CVector2f  *pTexVerts;		//!< The texture's UV coordinates
...
private:
	...
	void ProcessNextChunk(C3DSModel *pModel, tChunk *);

	//! This reads the object chunks
	void ProcessNextObjectChunk(C3DSModel *pModel, t3DObject *pObject, tChunk *);

	//! This reads the material chunks
	void ProcessNextMaterialChunk(C3DSModel *pModel, tChunk *);
	...
	void ReadObjectMaterial(C3DSModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk);
