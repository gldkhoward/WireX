...
bool CLoad3DS::Import3DS(C3DSModel *pModel, char *strFileName)
{
...
void CLoad3DS::ProcessNextChunk(C3DSModel *pModel, tChunk *pPreviousChunk)
{
...
void CLoad3DS::ProcessNextObjectChunk(C3DSModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk)
{
...
void CLoad3DS::ProcessNextMaterialChunk(C3DSModel *pModel, tChunk *pPreviousChunk)
{
	// The current chunk to work with
	tChunk currentChunk = {0};
...
void CLoad3DS::ReadUVCoordinates(t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	pObject->pTexVerts = new CVector2f [pObject->numTexVertex];
...
void CLoad3DS::ReadObjectMaterial(C3DSModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk)
{
...
CVector3f Vector(CVector3f vPoint1, CVector3f vPoint2)
{
	CVector3f vVector;							// The variable to hold the resultant vector
...
{
	CVector3f vResult;							// The variable to hold the resultant vector
...
{
	CVector3f vCross;								// The vector to hold the cross product
												// Get the X value
...
void CLoad3DS::ComputeNormals(C3DSModel *pModel)
{
	...
	for(int index = 0; index < pModel->numOfObjects; index++)
	{
		...
		CVector3f *pNormals		= new CVector3f [pObject->numOfFaces];
